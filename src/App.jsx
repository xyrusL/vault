...
function App() {
  ...
  return (
    <main className="vault-shell">
      ...
      <div className="vault-content relative z-10 mx-auto grid min-h-screen w-full max-w-[1120px] items-center gap-6 px-4 py-5 sm:gap-8 sm:px-5 sm:py-7 lg:grid-cols-[280px_580px] lg:justify-between lg:gap-14 lg:px-10">
        <section
          className="brand-panel mx-auto w-full max-w-[280px] lg:mx-0"
        ...
        >
          <div className="text-center lg:mb-8">
            ...
            <img
              src="/vault-logo.svg"
              alt="Vault"
              className="mx-auto h-auto w-[180px] sm:w-[205px]"
            />
            <p className="mx-auto mt-2 max-w-[260px] text-[0.94rem] leading-relaxed text-slate-400">
          ...
          <div className="mx-auto hidden w-fit flex-col gap-5 lg:flex lg:mx-0">
            {benefits.map(({ icon: Icon, title, description }) => (
              <div key={title} className="flex items-start gap-4">
                <div className="grid size-10 shrink-0 place-items-center rounded-full bg-[#0b171b] text-[#23d5c7] ring-1 ring-white/[0.03]">
                  <Icon className="size-[18px] stroke-[1.5]" />
                </div>
                <div>
                  <h2 className="text-sm font-medium text-white">{title}</h2>
                  <p className="mt-1 whitespace-pre-line text-[13px] leading-[1.45] text-slate-400">
                    {description}
                  </p>
                </div>
              </div>
        ...
        <section className="w-full max-w-[580px] justify-self-center">
          <div className="login-card rounded-[20px] border border-slate-500/60 px-4 py-6 sm:px-10 sm:py-9">
            <header className="mb-6 text-center sm:mb-7">
              <h2 className="text-[1.55rem] font-bold tracking-[-0.025em] text-white sm:text-[1.7rem]">
                Welcome Back
              </h2>
            ...
            >
              {loginMode !== "challenge" && (
                <div>
                  ...
                  <div className="input-shell flex items-center gap-3 rounded-lg border border-slate-600/60 px-4">
                    <Mail
                    ...
                    <input
                      ...
                      className="h-[50px] min-w-0 flex-1 bg-transparent text-[15px] text-white outline-none placeholder:text-slate-400"
                    />
                  </div>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="input-shell flex items-center gap-3 rounded-lg border border-slate-600/60 px-4">
                    ...
                    <button
                      ...
                      className="-mr-3 grid size-11 shrink-0 place-items-center text-slate-400 transition-colors hover:text-[#25d5c7] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25d5c7] sm:-mr-2"
                      aria-label={
                ...
                <div>
                  ...
                  <div className="input-shell flex items-center gap-3 rounded-lg border border-slate-600/60 px-4">
                    ...
                    <input
                      ...
                      className="h-[50px] min-w-0 flex-1 bg-transparent text-[15px] tracking-[0.2em] text-white outline-none placeholder:tracking-normal placeholder:text-slate-400"
                    />
                  </div>
                  {loginMode === "challenge" && (
              ...
              {loginMode !== "challenge" && (
                <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3 text-sm">
                  <label className="flex cursor-pointer items-center gap-3 text-slate-400">
                    ...
                    />
                    <span className="check-box grid size-5 place-items-center rounded-[4px] border border-slate-500 bg-transparent peer-checked:border-[#25d5c7] peer-checked:bg-[#25d5c7] peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-[#25d5c7]">
                      <svg
                        viewBox="0 0 14 14"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="primary-button h-[50px] w-full rounded-lg text-base font-semibold text-white transition hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#25d5c7] active:scale-[0.99] disabled:opacity-60"
              >
                {submitting
                  ? loginMode === "challenge"
                    ? "Verifying..."
              ...
              <button
                ...
                disabled={submitting}
                className="flex h-[50px] w-full items-center justify-center gap-3 rounded-lg border border-[#15988f] text-[15px] font-medium text-white transition hover:border-[#25d5c7] hover:bg-[#25d5c7]/5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#25d5c7] disabled:opacity-60"
              >
                {loginMode === "challenge" ? (
                  <>Back to login</>
                ) : loginMode === "password" ? (
